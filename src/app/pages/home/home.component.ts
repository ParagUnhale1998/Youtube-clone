...
categories = [
  ...
  constructor(private youtubeService: YoutubeApiService,private router:Router,private uiStateService :UiStateService) {}
  ...
  search(): void {
    ...
    if (this.seachQuery.trim() !== '') {
      ...
      this.youtubeService.searchVideos(this.seachQuery,this.nextPageToken).subscribe(
        (response: any) => {
          this.searchResults = this.searchResults ? [...this.searchResults, ...response.items] : response.items;
