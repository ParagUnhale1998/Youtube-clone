...
export class VideoPageComponent implements OnInit, OnDestroy {
  ...
  iframeWidth: any = 900; // Initial width of the iframe
  iframeHeight: any = 500; // Initial height of the iframe
  ...
  getWindowWidth() {
    ...
    // You can now perform actions based on the window width
    if (this.windowWidth < 670) {
      // Do something when the window width is less than 640px
      this.iframeWidth = 100 + '%';
      this.iframeHeight = 300;
    } else if (this.windowWidth >= 670 && this.windowWidth < 850) {
      // Do something when the window width is between 640px and 768px
      this.iframeWidth = 600;
      this.iframeHeight = 500;
    } else if (this.windowWidth >= 850 && this.windowWidth < 1080) {
      // Do something when the window width is between 768px and 1024px
      this.iframeWidth = 800;
      this.iframeHeight = 500;
    } else if (this.windowWidth >= 1080 && this.windowWidth < 1270) {
      // Do something when the window width is between 1024px and 1280px
      this.iframeWidth = 1000;
      this.iframeHeight = 500;
    } else if (this.windowWidth >= 1270 && this.windowWidth < 1350) {
      // Do something when the window width is between 1280px and 1536px
      this.iframeWidth = 700;
      this.iframeHeight = 500;
    } else if (this.windowWidth >= 1350 && this.windowWidth < 1400) {
      // Do something when the window width is between 1280px and 1536px
      this.iframeWidth = 800;
      this.iframeHeight = 500;
    } else if (this.windowWidth >= 1400 && this.windowWidth < 1490) {
      // Do something when the window width is between 1280px and 1536px
      this.iframeWidth = 820;
      this.iframeHeight = 500;
    } else {
      this.iframeWidth = 900;
      // Do something when the window width is greater than or equal to 1536px
    }
  }
